...
class Model(object):
    ...
    def __init__(self, data_config, img_feat, text_feat, d1, d2):
        ...
        self.ua_embeddings_4, self.ia_embeddings_4, self.ea_embeddings_4 = self.all_embeddings[4]
        ...
        self.batch_ratings = tf.matmul(self.u_g_embeddings_4, self.pos_i_g_embeddings_4,
                             ...
                             lambda_v * tf.matmul(self.u_g_embeddings_v, self.pos_i_g_embeddings_v,
                                                  transpose_a=False, transpose_b=True) + \
                             lambda_v * tf.matmul(self.u_g_embeddings_t, self.pos_i_g_embeddings_t,
                                                  transpose_a=False, transpose_b=True)
